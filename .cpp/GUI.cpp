...
#include "../.hpp/glfw3.h"
#include "../.hpp/GUI.h"
#include "../.hpp/stb_image.h"
#include "../.hpp/glm/glm.hpp"
#include "../.hpp/glm/gtc/matrix_transform.hpp"
#include "../.hpp/glm/gtc/type_ptr.hpp"

#include "../.hpp/Texture.h"
#include "../.hpp/Buffers.h"
#include "../.hpp/Shaders.h"
...
GUI::GUI() {
	...
	Shader shaderProgram(".vert/default.vert", ".frag/default.frag");
	...
	Shader lightShader(".vert/light.vert", ".frag/light.frag");
	// Generates Vertex Array Object and binds it
	VAO lightVAO;
	lightVAO.Bind();
	// Generates Vertex Buffer Object and links it to vertices
